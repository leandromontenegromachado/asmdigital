...
const templateVariables = [
  ...
  { key: 'link_relatorio', label: 'Link do relatorio ASM Digital' },
  { key: 'link_demanda', label: 'Link da demanda no Redmine' },
  { key: 'link_redmine', label: 'Link da demanda no Redmine' },
